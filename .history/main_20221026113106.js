...
li1.appendChild(li3Text);
ul.appendChild(li3)

let li4=document.createElement('li');
li1.style.cssText="padding-right:5px";
let li4Text=document.createTextNode("Testimonials");
li1.appendChild(li4Text);
ul.appendChild(li4)
