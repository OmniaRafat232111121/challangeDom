...
contentDiv.style.cssText = "background-color:green; display: flex; padding: 20px; flex-wrap: wrap; justify-content: center; gap: 20px; min-height: calc(100vh - 142px); box-sizing: border-box;"
for (let i = 1; i <= 15; i++) {
